...
public class ControladorEmpleado {
    ...
    public ArrayList<Usuario> ObtenerEmpleados(String cadena){
        ArrayList<Usuario> empleados = new ArrayList<>();
        try{
            Conexion conn = new Conexion();
            Connection conexion = conn.getConnection();
            
            String consulta = "SELECT ID,RUT,NOMBRE,DIRECCION,TELEFONO,MAIL,CARGO,TIPO_USUARIO FROM USUARIO WHERE (TIPO_USUARIO='E' or TIPO_USUARIO='V') AND (UPPER(RUT) LIKE '" + cadena.toUpperCase() + "%' OR UPPER(NOMBRE) LIKE '" + cadena.toUpperCase() + "%' "
                    + ")";
    ...
    public boolean AgregarEmpleado(Usuario u){
        try{
            Conexion conn = new Conexion();
            Connection conexion = conn.getConnection();
    ...
    public boolean ModificarEmpleado(Usuario u){
        try{
            Conexion conn = new Conexion();
            Connection conexion = conn.getConnection();
